...
export const signals: Signal[] = [
  {
    ...
    evidence: "A man approached a female speaker after a conference to question her credentials. AI is disrupting long-standing expertise hierarchies. The voices now standing out may be the ones historically excluded — because AI was trained on centuries of male-dominated publishing, compressing dominant voices and amplifying those who were not.",
    read: "The credentialing system is built on assumptions about who counts as an expert. AI is restructuring that system. The people most threatened are defending an assumption they've never had to examine — because it always worked in their favour.",
  ...
  },
  {
    ...
    read: "Proximity bias decided who got trusted. Surveillance filled the gap where trust should have been. AI runs the surveillance. AI trains on the output. The return to office mandate sits on top of this: if presence built trust, why does the room need monitoring software? The circular argument collapses. The room never trusted the people in it. It just trusted them more than the people outside.",
