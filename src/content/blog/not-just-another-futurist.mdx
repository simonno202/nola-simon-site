...
date: "2026-03-27"
description: "The futures industry performs certainty. The harder work is auditing what your organization already assumes before the direction gets chosen. Nola Simon | Everyday Futurism."
...
This is the methodology in full. If you're wondering what it looks like applied to your organization's specific assumptions — before the direction hardens, before the convergences arrive at the crossing point — that's what the Assumption-Ground Audit is for.

[The AGA: what it is and how it works →](/aga)
